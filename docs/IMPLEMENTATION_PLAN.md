...
3. **次は Phase 5.2** — 解析状態の可視化統一（詳細: [`plans/phase-5-2-analysis-status.md`](plans/phase-5-2-analysis-status.md)）。
...
- [ ] **解析状態の可視化統一** — 詳細計画: [`plans/phase-5-2-analysis-status.md`](plans/phase-5-2-analysis-status.md)
...
| **1** | **解析状態可視化** | 5.2 | M | **次に着手** |
| 2 | 通知履歴永続化 | 2.5 | M | 未着手 |
| 3 | Gemini JSON 改善 | 5.2 | S | 未着手 |
...
- [ ] 5.2 解析状態可視化 — [`plans/phase-5-2-analysis-status.md`](plans/phase-5-2-analysis-status.md)
- 2.5 通知履歴永続化
- 5.2 Gemini JSON 改善
- 5.1 プロンプト・回帰素材の継続
...
- [`plans/phase-5-2-analysis-status.md`](plans/phase-5-2-analysis-status.md) — Phase 5.2 解析状態可視化（次タスク）
