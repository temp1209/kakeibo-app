...
> **現行版**（2026-07-15 更新）。旧版は [`archive/`](archive/) を参照。索引は [`README.md`](README.md)。

Phase 7〜9 完了。**Phase 9.5** 要件（PR #6）。**Phase 10** 複数 AI/API 実装完了（`feat/phase10-multi-ai-provider`、PR 未マージ）。次は Phase 11。
...
| **10** | 複数 AI / API・フェイルオーバー | ✅ 実装（**PR 待ち**） |
...
2. **Phase 10** — 複数 Gemini キーのフェイルオーバー（マージ後に確定）。
