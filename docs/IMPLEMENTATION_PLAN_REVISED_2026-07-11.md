...
3. **初回体験の体系化が次の主戦場** — 7.3 のガードを土台に 7.1 オンボーディングへ。
...
- [ ] **7.1.3 バックアップの軽い案内（任意）**
  - オンボーディング最後に「月1回 JSON エクスポートを推奨」1画面、または設定へのリンク
- [ ] **7.1.4 要件・README との整合**
  - `REQUIREMENTS.md` にオンボーディングフローを正式 § として追記

**完了条件**: 新規インストール後、設定タブを知らなくても最低限のセットアップに誘導される。

**依存**: 7.3 完了済み。7.2' のコミット後に着手推奨。
...
| APIキー「初回起動で入力」 | **7.1 オンボーディング + 7.3 ガード** | 7.3 完了、7.1 未着手 |
